...
1. 相对地址的定义：
        ...
        被链接文件相对于当前页面的地址。 只包含本地路径的网页地址，地址通常以“/”和“../”表示层级关系。
...
3. http status code
    ...
    [RSET API tutoral](http://www.restapitutorial.com/httpstatuscodes.html)
...
4.  http verbs
    ...
    [http verb](http://www.w3.org/Protocols/rfc2616/rfc2616-sec9.html)
...
更多node里的verbs实行，[参见这里](https://github.com/jshttp/methods/blob/master/index.js
)
## req取参数的3种方法
